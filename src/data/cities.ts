...
export const CITIES: City[] = [
  ...
  },
  {
    ...
    name: 'Puebla',
    country: 'México',
    center: { lat: 19.0437, lng: -98.1981 },
    bounds: { minLat: 18.98, maxLat: 19.12, minLng: -98.32, maxLng: -98.12 },
    supported: true,
    locales: ['es-MX', 'en-US'],
  },
  {
...
export const START_SUGGESTIONS: Record<string, StartSuggestion[]> = {
  barcelona: [
    { id: 'bcn-zone-eixample', label: 'Eixample', lat: 41.3916, lng: 2.1649, kind: 'zone' },
    { id: 'bcn-zone-gotic', label: 'Barri Gòtic', lat: 41.3833, lng: 2.1761, kind: 'zone' },
    { id: 'bcn-zone-born', label: 'El Born', lat: 41.3855, lng: 2.1825, kind: 'zone' },
    { id: 'bcn-zone-gracia', label: 'Gràcia', lat: 41.4036, lng: 2.1575, kind: 'zone' },
  ...
  cdmx: [
    { id: 'cdmx-zone-centro', label: 'Centro Histórico', lat: 19.4326, lng: -99.1332, kind: 'zone' },
    { id: 'cdmx-zone-reforma', label: 'Reforma', lat: 19.427, lng: -99.1677, kind: 'zone' },
    { id: 'cdmx-zone-condesa', label: 'Condesa / Roma', lat: 19.4117, lng: -99.1695, kind: 'zone' },
    { id: 'cdmx-zone-polanco', label: 'Polanco', lat: 19.4335, lng: -99.195, kind: 'zone' },
    { id: 'cdmx-zone-coyoacan', label: 'Coyoacán', lat: 19.3492, lng: -99.1628, kind: 'zone' },
    { id: 'cdmx-zocalo', label: 'Zócalo', lat: 19.4326, lng: -99.1332, kind: 'plaza' },
  ],
  puebla: [
    { id: 'pue-zone-centro', label: 'Centro histórico', lat: 19.0437, lng: -98.1981, kind: 'zone' },
    { id: 'pue-zone-angelopolis', label: 'Angelópolis', lat: 19.0195, lng: -98.2435, kind: 'zone' },
    { id: 'pue-zone-huexotitla', label: 'Huexotitla', lat: 19.0385, lng: -98.2205, kind: 'zone' },
    { id: 'pue-zone-lapaz', label: 'La Paz', lat: 19.058, lng: -98.215, kind: 'zone' },
    { id: 'pue-zone-analco', label: 'Analco', lat: 19.0405, lng: -98.1905, kind: 'zone' },
    { id: 'pue-zone-fuertes', label: 'Los Fuertes', lat: 19.0575, lng: -98.1848, kind: 'zone' },
    { id: 'pue-zone-cholula', label: 'Cholula', lat: 19.0625, lng: -98.3035, kind: 'zone' },
    { id: 'pue-zocalo', label: 'Zócalo', lat: 19.0437, lng: -98.1981, kind: 'plaza' },
  ],
  lisboa: [
    { id: 'lis-zone-baixa', label: 'Baixa', lat: 38.7075, lng: -9.1364, kind: 'zone' },
    { id: 'lis-zone-belem', label: 'Belém', lat: 38.6979, lng: -9.2065, kind: 'zone' },
  ...
  roma: [
    { id: 'rom-zone-centro', label: 'Centro storico', lat: 41.8992, lng: 12.4731, kind: 'zone' },
  ...
  paris: [
    { id: 'par-zone-centre', label: 'Centre', lat: 48.853, lng: 2.3499, kind: 'zone' },
  ...
  'buenos-aires': [
    { id: 'ba-zone-centro', label: 'Microcentro', lat: -34.6037, lng: -58.3816, kind: 'zone' },
